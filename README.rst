...
Otherwise, download the most recent stable release (`v0.9.4rc26
<https://github.com/odkr/sortableclasses.py/archive/v0.9.4rc26.tar.gz>`_),
...
You can do all of the above by::
    ...
    curl https://codeload.github.com/odkr/sortableclasses.py/tar.gz/v0.9.4rc26 | 
        tar -xz
